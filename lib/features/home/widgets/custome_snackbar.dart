...
class CustomeSnackBar {
  ...
  static void show(String message) {
    _showSnackBar(message, backgroundColor: AppColors.neutralS);
  }
  ...
  static void loading(String message) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: AppColors.neutralS,
        behavior: SnackBarBehavior.floating,
        margin: const EdgeInsets.all(16),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
      ...
      AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text(
              cancelText,
              style: const TextStyle(color: AppColors.neutralS),
            ),
          ),
          TextButton(
            ...
            child: Text(
              confirmText,
              style: TextStyle(
                color: isDanger ? AppColors.error : AppColors.neutralS,
